  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 p-4 md:p-0'>
      {posts.map(({ slug, frontmatter }) => (
          <div
            key={slug}
            className='p-4 max-w-sm mx-auto bg-white rounded-xl shadow-md flex items-center space-x-4 divide-y divide-slate-600 divide-solid mb-2 w-full shadow-2xl'
          >
              <Head>

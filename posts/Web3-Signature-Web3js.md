...
[Test live](https://mosi-sol.github.io/VerifySignature/)

# SIGNATURE
Sign message by wallet & verify by smart contract.

using `web3js` + `javascript`
...
<body class="container-fluid">
  <h1 class="my-5">Verify Signature - Web3js</h1>
  ...
  <div class="bg-dark text-warning text-center py-1 mt-1">
    github @mosi-sol &nbsp;&middot;&nbsp; learning perpuses | <a href="https://github.com/mosi-sol/VerifySignature">Source</a>
  </div>
  ...
  <script>
    async function signMessage() {
      if (!window.ethereum) return alert("Please Install Metamask");
        ...
        // message to sign
        const message = "the message here... [hard code]";
        console.log({ message });
